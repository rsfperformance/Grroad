...
@section('content')
    <div class="page__material">
        <div class="page__material-banner" style="background-image: url(/img/bg/bg-material.webp);">
            <div class="banner__content">
                <div class="general__history">
                    ...
                    <a href="" class="active">{{ __('asd.Асфальтовое покрытие') }}</a>
                </div>
                <h2 class="general__title">{{ __('asd.Асфальтовое покрытие') }}</h2>
            </div>
        ...
        <div class="page__material-container">
            ...
            @foreach(\App\Models\Materials::where('class', 2)->get() as $datum)
                <a href="/materials/{{ $datum->id }}" class="box">
                    ...
                    <div class="content">
                        ...
                        <p class="txt">{!! substr($datum['description1_'.$lan], 3, 128) !!}...</p>
                    </div>
                 </a>
            @endforeach
        </div>
